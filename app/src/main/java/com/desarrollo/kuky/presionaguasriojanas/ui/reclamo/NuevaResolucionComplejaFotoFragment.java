...
public class NuevaResolucionComplejaFotoFragment extends Fragment
    ...
    private Button bGuardarFoto, bCancelar;
    private ImageView ivFoto;
    private ImageButton bCapturar;
    private byte[] bytesGeneral;
     ...
     */
    private static final String TAG = "NuevaResolucionComplejaFotoFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_nueva_resolucion_foto, container, false);
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        bGuardarFoto = view.findViewById(R.id.bGuardarFoto);
        bCancelar = view.findViewById(R.id.bCancelar);
        setPrimaryFontBold(this.getActivity(), bGuardarFoto);
        setPrimaryFontBold(this.getActivity(), bCancelar);
        ivFoto.setVisibility(View.INVISIBLE);
        mTextureView = view.findViewById(R.id.texture);
        bGuardarFoto.setOnClickListener(v -> {
            abrirResolucion();
        });
        bCancelar.setOnClickListener(v -> {
            ivFoto.setVisibility(View.INVISIBLE);
            mTextureView.setVisibility(View.VISIBLE);
            bCapturar.setVisibility(View.VISIBLE);
            bGuardarFoto.setVisibility(View.INVISIBLE);
    ...
    private void abrirResolucion() {
        ...
        resolucionReclamo.setFotoInicio(comprimirImagen(bytesGeneral));
        if (resolucionReclamoControlador.abrirResolucion(this.getActivity(), resolucionReclamo) == EXITOSO) {
            if (tramiteControlador.actualizarEstado(tramite, this.getActivity()) == EXITOSO) {
                abrirActivity(this.getActivity(), NuevaResolucionComplejaActivity.class);
            }
        }
    }
    ...
    /**
     * Opens the camera specified by {@link NuevaResolucionComplejaFotoFragment#mCameraId}.
     */
    ...
    private class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            getActivity().runOnUiThread(() -> {
                ...
                bGuardarFoto.setVisibility(View.VISIBLE);
